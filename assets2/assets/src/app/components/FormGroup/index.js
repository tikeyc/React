...
const controllerByType = args => {
  ...
  switch (type) {
    ...
    case 'quarterly':
      return <DatePickerQ options={options} onSelect={onSelect} />;
    case 'quarterlyRange':
    ...
    case 'dayRange':
      return <DateRange startType="day" endType="day" options={options} onSelect={onSelect} />;
    case 'radio':
...
class FormGroup extends Component {
  ...
  shouldComponentUpdate(nextProps) {
    return (
      ...
      this.props.notEqual !== nextProps.notEqual
    );
  }
  ...
  render() {
    ...
    return (
      <div
        className={`form-group  ${type} ${className} ${unit && !type.includes('Range') ? 'has-unit' : ''}`}
        style={style}
